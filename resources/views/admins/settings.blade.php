...
@section('main-content')
    ...
    <main class="p-6">
        <div class="modal-content py-4">
            <h2 class="text-4xl mb-4 text-pink-950">إدارة مشرفين</h2>
            <p class="text-gray-600 mt-4 mb-6 text-center md:text-right">لإضافة مشرف جديد اضغط على الزر أدناه</p>
            <button id="addStudentBtn" class="btn1 p-1.5 hover:text-white" onclick="openModal()">إضافة مشرف</button>
        </div>
        <!-- table -->
        @if(!$admins->isEmpty())
        <div class="bg-white p-6 rounded-lg shadow-lg mt-16 overflow-x-auto">
            <h2 class="text-4xl mb-4 text-pink-950">قائمة مشرفين </h2>
...
<div class="p-4 mt-8 bg-gray-100 rounded-lg shadow w-full">
    <h3 class="text-center font-bold text-lg text-pink-950 mb-4">لا يوجد مشرفين</h3>
</div>
...
@endif
    ...
    <div id="studentModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
        <div class="bg-white p-6 rounded-lg w-1/3">
            <h2 class="text-xl mb-4">إضافة مشرف جديد</h2>
            <form method="POST" action="">
                @csrf
            <input type="text"  name="name"  id="studentName" placeholder="اسم مشرفين" class="border p-2 w-full mb-2">
            <input type="email"  name ="email" id="studentID1" placeholder="ايميل" class="border p-2 w-full mb-2">
    ...
    <div id="studentEdite" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
        <div class="bg-white p-6 rounded-lg w-1/3">
            <h2 class="text-xl mb-4">تعديل بيانات مشرف </h2>
            <input type="text" id="studentName1" placeholder="اسم مشرفين" class="border p-2 w-full mb-2">
