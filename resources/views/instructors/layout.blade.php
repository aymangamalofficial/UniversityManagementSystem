...
<head>
    ...
    <link rel="stylesheet" href="result.css">
        ...
        <link rel="stylesheet" href="{{ asset('public/resources/instructors/instractor profile/assit profilo/assit.css') }}">
        <link rel="stylesheet" href="{{ asset('public/resources/instructors/assistant/absence/absence.css') }}">
        <link rel="stylesheet" href="{{ asset('public/resources/instructors/assistant/absiment/absence.css') }}">
        <link rel="stylesheet" href="{{ asset('public/resources/instructors/assistant/matriel/dash.css') }}">
        <link rel="stylesheet" href="{{ asset('public/resources/instructors/assistant/result/result.css') }}">
        ...
        <nav class="bg-gray-800 text-white py-4 px-6 flex justify-between items-center shadow-lg fixed top-0 left-0 w-full">
            ...
            <div class="hidden md:flex items-center space-x-6" id="nav-links">
                <ul class="flex space-x-6">
                    <li><a href="{{ route('instructors.profile') }}" class="hover:text-blue-300">الملف الشخصي</a></li>
                </ul>
            </div>
...
<aside id="sidebar" class="fixed top-10 right-0 h-fill bg-blue-100/75 transform translate-x-full transition-transform duration-300 z-50 md:translate-x-0">
    <div class="sidebar mt-16">
        <ul>
            ...
            <li class="mb-4"><a href="{{ route('instructors.profile') }}" class="block px-3 py-1 text-black hover:bg-pink-950 hover:text-blue-200"> الملف الشخصي</a></li>
        </ul>
    </div>
</aside>
...
@yield('main-content')
    ...
    <script src="{{ asset('public/resources/instructors/instractor/profile/assit.js') }}"></script>
        <script src="{{ asset('public/resources/instructors/assistant/assiment/assiment.js') }}"></script>
        <script src="{{ asset('public/resources/instructors/assistant/materials/materials.js') }}"></script>
        <script src="{{ asset('public/resources/instructors/assistant/result/result.js') }}"></script>
