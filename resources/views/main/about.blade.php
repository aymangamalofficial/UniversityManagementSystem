...
<head>
    ...
    <link href="{{ asset('public/css/main/about.css') }}" rel="stylesheet">
    ...
    <header>
        <nav class="bg-gray-800 text-white py-4 px-6 flex justify-between items-center shadow-lg">
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="/unversity/Home/home.html" class="f1 text-lg font-bold mr-2">جامعة أسيوط الجديدة التكنولوجية</a>
            </div>

            <!-- Navigation Links -->
            <div class="f2 hidden md:flex items-center space-x-6">
                <ul class="flex space-x-6">
                    <li><a href="/unversity/Home/home.html" class="f1 hover:text-blue-300" > الصفحة الرئيسية </a></li>
                    <li><a href="#hero" class="f1 hover:text-blue-300" > عن الجامعة</a></li>
                    ...
                    <li class="relative group">
                        ...
                        <ul class="absolute right-0 mt-1 hidden  space-y-2 text-black bg-blue-100 bg-opacity-80 border border-gray-300 rounded-md group-hover:block hover:block">
                            <li><a href="/unversity/collage/الصناعة و الطاقة/collage1.html" class="block px-4 py-2 hover:bg-blue-100 hover:text-red-900">
                                كلية تكنولوجيا الصناعة و الطاقة
                            </a></li>
                            <li><a href="/unversity/collage/علوم صحية/collage1.html" class="block px-4 py-2 hover:bg-blue-100 hover:text-red-900">
                                كلية تكنولوجياعلوم صحية
                            </a></li>
                        </ul>
                    </li>

                    <li><a href="/unversity/Home/home.html#contact" class="f1 hover:text-blue-300"> تواصل معنا</a></li>
                </ul>
            </div>
            ...
            <div class="f2 flex items-center space-x-3">
                ...
                <button class="login hidden md:inline-block bg-blue-300 text-black hover:shadow-lg hover:text-white transition px-4 py-2 rounded-lg duration-200">
                    <a class="signin" href="/Safety/Login/login.html">تسجيل الدخول <i class="fi fi-rr-sign-in-alt"></i></a>
                </button>
                <!-- Mobile Menu Button -->
