...
<head>
    ...
    <link rel="stylesheet" href="{{ asset ('public/css/main/collage1/collage.css')}}">
...
<body>
    ...
    <section  id="hero" class="hero bg-cover bg-center min-h-screen flex flex-col justify-center items-center text-white relative text-center px-4">
        ...
        <div class="z-10 max-w-3xl">
            ...
            <h1 class="text-3xl sm:text-5xl font-bold text-blue-300">كلية تكنولوجيا الصناعة و الطاقة  </h1>
            <p class="f1 text-lg sm:text-xl mt-4 text-black bg-blue-50 opacity-40  px-4 py-2 ">
تضم الكلية 4 برامج تعليمية
            </p>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-2 gap-8 items-center flex flex-row-reverse ">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="text-center">
                        <img src="{{ asset('public/img/collage/الصناعة و الطاقة/it.jpg ')}}" class="rounded-2xl mx-auto w-50 h-50 mb-3">
    ...
    <section class="about">
        <div id="About" class="p-8 mb-8">
            ...
            <div class="grid md:grid-cols-2 gap-8 items-center flex flex-row-reverse ">
                ...
                <div class="genral">
                    <h1 class="text-2xl font-bold text-gray-800 leading-tight">
                        برنامج شبكات و نقل و توزيع الكهرباء
                    </h1>
                    <!-- <p class="text-gray-600 mt-4 mb-6">
                    </p> -->
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="text-center">
                        <img src="{{ asset('public/img/collage/الصناعة و الطاقة/electric.jpg')}}" class="rounded-2xl mx-auto w-50 h-50 mb-3">
                        <!-- <h3 class="font-bold text-gray-800 text-2xl">IT</h3> -->
                        <!-- <p class="text-gray-600 text-sm">
    ...
    <section class="about">
        <div id="About" class="p-8 mb-8">
            ...
            <div class="grid md:grid-cols-2 gap-8 items-center flex flex-row-reverse ">
                ...
                <div class="genral">
                    <h1 class="text-2xl font-bold text-gray-800 leading-tight">
                    برنامج الأجهزة الإلكتورنية و الكهربائية
                    </h1>
                    <!-- <p class="text-gray-600 mt-4 mb-6">
                    </p> -->
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="text-center">
                        <img src="{{ asset('public/img/collage/الصناعة و الطاقة/device.jpg')}}" class="rounded-2xl mx-auto w-50 h-50 mb-3">
                        <!-- <h3 class="font-bold text-gray-800 text-2xl">IT</h3> -->
                        <!-- <p class="text-gray-600 text-sm">
    ...
    <section class="about">
        <div id="About" class="p-8 mb-8">
            ...
            <div class="grid md:grid-cols-2 gap-8 items-center flex flex-row-reverse ">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="text-center">
                        <img src="{{ asset('public/img/collage/الصناعة و الطاقة/food.jpg')}}" class="rounded-2xl mx-auto w-50 h-50 mb-3">
                        <!-- <h3 class="font-bold text-gray-800 text-2xl">IT</h3> -->
                        <!-- <p class="text-gray-600 text-sm">
    ...
    <script src="{{ asset ('public/js/main/collage1/collage.js')}}"></script>
</body>
</html>
