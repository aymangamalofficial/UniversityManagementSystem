            ...
            <div class="f2 flex items-center space-x-3">
                ...
                {{-- <div class="relative">
                    <button id="avatar-btn" class="focus:outline-none">
                        <img src="{{ asset('public/img/user.png') }}" alt="User Avatar" class="w-10 h-10">
                    </button>


                    <div id="dropdown-menu" class="hidden absolute left-0 mt-2 w-48 bg-white text-black shadow-lg rounded-lg py-2">
                        <a href="/dr/profilo/dr.html" class="block px-4 py-2 hover:bg-gray-200">الملف الشخصي</a>
                        <a href="/logout.html" class="block px-4 py-2 hover:bg-red-500 text-red-700 hover:text-white">تسجيل الخروج</a>
                    </div>
                </div> --}}
